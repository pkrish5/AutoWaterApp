...
class _PlantGalleryScreenState extends State<PlantGalleryScreen> {
  ...
  Future<void> _loadInitialImages() async {
    ...
    try {
      ...
      final result =
          await api.getPlantImagesPaginated(widget.plant.plantId);
          ...
          children: [
            IconButton(
              ...
              icon: Container(
                ...
                child:
                    const Icon(Icons.arrow_back, color: AppTheme.leafGreen),
              ),
            ),
            const Spacer(),
            Column(
  ...
  void _showSnackBar(String msg, {bool isError = false}) {
    ScaffoldMessenger.of(context).showSnackBar(
      SnackBar(
        content: Text(msg),
        backgroundColor:
            isError ? AppTheme.terracotta : AppTheme.leafGreen,
      ),
    );
  }
}
